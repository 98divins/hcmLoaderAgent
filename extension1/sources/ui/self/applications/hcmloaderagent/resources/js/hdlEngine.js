/**
 * Moteur HDL — génération du fichier .dat et de son archive .zip.
 *
 * Module autonome : aucune dépendance VB, aucune dépendance externe. Il ne
 * connaît ni l'objet métier ni la page qui l'appelle — il consomme un « plan de
 * chargement » (cf. docs/ARCHITECTURE-AGENT-HDL.md § 4.4) et rend des octets.
 *
 * Le constructeur de ZIP (méthode « stored », sans compression) a été validé
 * indépendamment via Node/unzip/python avant intégration, et le fichier produit
 * a été chargé avec succès par le moteur HDL réel d'Oracle
 * (RequestId 9908614, ORA_SUCCESS, 3/3 lignes).
 */
define([], () => {
  'use strict';
